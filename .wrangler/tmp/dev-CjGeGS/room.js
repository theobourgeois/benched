    ...
    switch (message.t) {
      ...
      case "team": {
        ...
        for (const [id, other] of this.seats)
          if (id !== connection.id && other.team === seat.team) other.team = 1 - seat.team;
        break;
      }
      case "club":
...
// .wrangler/tmp/bundle-TM0v0t/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TM0v0t/middleware-loader.entry.ts
