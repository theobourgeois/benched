...
export const FEEL_PARAMS: FeelParam[] = [
  ...
  p(
    ...
    1,
    0.005,
    'Cruise penalty with the puck in traffic. Beaten defenders on a rush still cannot outrun you.',
  ...
  p(
    ...
    1,
    0.005,
    'Hustle penalty with the puck in traffic. A rush from behind is capped to this same top.',
    'puck-carriers get run down in traffic',
    'you keep your extra gear with the puck',
  ),
  ...
  p(
    ...
    1.2,
    0.02,
    'How close an opponent has to be to pick a tape-to-tape pass. Standing in the lane is not enough.',
    'standing in the lane picks it',
    'they have to smother it',
    'm',
  ),
  p(
    'puck',
    ...
    1.6,
    0.02,
    'How high a teammate can take a lifted pass.',
    'saucers are caught at the chest',
    'they have to land at the skates',
    'm',
  ),
  p(
    'puck',
  ...
  p(
    ...
    1.2,
    0.02,
    'How far off the aimed line the puck can sit and still be poked.',
    'a rough aim still takes it',
    'you have to aim right at the puck',
    'm',
  ),
  p(
    'puck',
    ...
    3,
    0.05,
    'How far from the body the jab reaches along the left stick.',
  ...
  p(
    ...
    0.8,
    0.05,
    'Cosine limit between aim and facing; aims further round jab down the blade instead.',
    'you poke only where you face',
    'you can jab out to the side',
  ),
  p(
    'puck',
    'pokeKick',
    ...
    10,
    0.1,
    "Speed a poked puck leaves the carrier's blade at, back toward the poker.",
    'the puck squirts out to you',
    'it drops dead between you',
    'm/s',
  ),
  p(
    'puck',
    ...
    2,
    0.05,
    'Share of the kick that goes out sideways off the carrier instead of back to the poker.',
    'pokes knock it into space',
    'pokes pull it straight back',
  ),
  p(
    'puck',
    'pokeRecover',
    ...
    1,
    0.02,
    'Seconds a poked carrier cannot touch the puck.',
    'a poke is a clean steal',
    'they scoop it right back',
    's',
  ),
  p(
    'puck',
    ...
    0.8,
    0.02,
    'A carrier this close to the line from your stick to the puck is shielding it.',
    'protecting the puck is a wall',
    'you can poke through bodies',
    'm',
  ),
  p(
    'puck',
  ...
  p(
    ...
    0.8,
    0.02,
    'Extra lane width while holding a sweep poke.',
    'a sweep forgives a rough aim',
    'a sweep needs the same aim as a jab',
    'm',
  ),
  p(
    'puck',
  ...
  p(
    ...
    2,
    0.02,
    'How long you stay a shot block after the flop: limp on the ice, then get up.',
    'you lie there longer',
  ...
  p(
    ...
    0.6,
    0.02,
    'How long the committed flop lasts before the body goes limp.',
    'you hang in the dive',
  ...
  g(
    ...
    1,
    0.05,
    'Share of the extension time a short reach takes, like a hand to the near post.',
    'near-post shots beat the hands',
    'the short side is sealed at once',
  ),
  g(
    'setRead',
    'Set read',
    ...
    1,
    0.05,
    'Share of the reaction time a square goalie needs against a shooter in close.',
    'in-tight shots beat a set goalie',
    'a set goalie reads everything in tight',
  ),
  g(
    'depthMin',
    'Crease depth',
    ...
    1.6,
    0.05,
    'How far off the goal line the goalie plays a shooter in tight.',
    'the goalie challenges, lateral moves beat them',
    'the goalie sits deep, corners open up',
    'm',
  ),
  g(
    'brake',
    ...
    0.4,
    0.01,
    'Seconds of their own speed a CPU goalie stops short by, so a push across does not overshoot.',
    'the goalie settles on the angle',
    'the goalie slides past a fake',
    's',
  ),
  g(
    'dekeRange',
    ...
    6,
    0.1,
    'A carrier this close pulling the puck back across the crease draws a pad slide.',
    'the goalie slides on moves from further out',
    'the goalie never guesses on a pull across',
    'm',
  ),
  g(
    'standScale',
    'Stance by difficulty',
    0,
    2,
    0.05,
    'How much the difficulty reach also widens the standing pads.',
    'Legend goalies fill the net, Rookies leave holes',
    'every goalie stands the same size',
  ),
  g(
    'lead',
    'Carrier lead',
    ...
    0.4,
    0.01,
    'Seconds ahead of a puck carrier the goalie positions, so a cut is met rather than chased.',
    'the goalie bites on a fake',
    'a cut across leaves the goalie trailing',
    's',
  ),
  g(
    'push',
